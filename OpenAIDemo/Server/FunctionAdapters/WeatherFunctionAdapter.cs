    ...
    public class WeatherFunctionAdapter : IFunctionAdapter
    {
        ...
        public FunctionDefinition GetFunctionDefinition()
        {
            return new FunctionDefinition()
            {
                ...
                Description = "Gets the weather forecasts for a given city for the next days. Ignore the temperatures in Farheneit in your responses, unless explicitly asked",
